![Let's Talk](http://i.imgur.com/mopJuh4.png)

![Screenshot](http://i.imgur.com/dYkBCBq.png)

A self-hosted chat app for small teams built by [Security Compass][seccom].
Base on Let's Chat. I have changed something that makes it more powerful and beautiful (by Andy Nguyen)
NOTICE: This open-source is still developing but you can clone and take a look. By the way, it doesn't have search function. I'm working on it!
